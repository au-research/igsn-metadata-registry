...
<xsl:text>{"@context": ["http://schema.org/",
    ...
    "objectType"  : "Sample",
            ...
            <xsl:apply-templates select="igsn:curationDetails/igsn:curation/igsn:curator" mode="json-ld"/>
    ...
    <xsl:template match="igsn:resourceIdentifier" mode="igsn-id">
        <xsl:text>    "@id": "http://igsn.org/</xsl:text><xsl:value-of select="."/><xsl:text>",
</xsl:text>
    </xsl:template>
...
<xsl:text>
    ...
    <xsl:template match="igsn:curator" mode="json-ld">
    ...
    <xsl:template match="igsn:contributorName" mode="igsn">
        <xsl:value-of select="."/>
    </xsl:template>


    <xsl:template match="igsn:resourceTitle" mode="text">
        <xsl:value-of select="."/>
    </xsl:template>
