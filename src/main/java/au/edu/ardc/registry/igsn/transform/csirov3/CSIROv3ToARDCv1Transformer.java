...
public class CSIROv3ToARDCv1Transformer implements Transformer {

    private static final String path = "xslt/csiro_v3_to_ardc_v1.xsl";

    private static final String targetSchemaID = SchemaService.ARDCv1;

    private Map<String, String> parameters = new HashMap<>();

    /**
     * Transform a {@link Version} with schema csirov1 to a {@link Version} with schema
     * ardcv1
     ...
     * @param key String supported {prefix}
     * @param value String the value of the given parameter
     * @return self for fluent API usage
     */
    public CSIROv3ToARDCv1Transformer setParam(String key, String value) {
