...
import au.edu.ardc.registry.igsn.provider.ardcv1.ARDCv1VisibilityProvider;
...
class MetadataProviderFactoryTest {
	...
	@Test
	void create_Schema_ReturnsInstanceOfVisibilityProvider() {

		VisibilityProvider actual = (VisibilityProvider) MetadataProviderFactory
				.create(schemaService.getSchemaByID(SchemaService.ARDCv1), Metadata.Visibility);

		assertThat(actual).isInstanceOf(VisibilityProvider.class);
		assertThat(actual).isInstanceOf(ARDCv1VisibilityProvider.class);
	}
